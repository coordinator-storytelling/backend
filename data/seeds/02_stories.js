...
exports.seed = function(knex, Promise) {
  return knex('stories').delete()
    .then(function () {
      return knex('stories').insert([
        {
            title: 'Poverty Discriminates: The Social PreCOP',
            country: 'Kiribati',
            small_image: "https://res.cloudinary.com/divjebnjg/image/upload/v1550340095/Kiribati.jpg",
            large_image: "https://res.cloudinary.com/divjebnjg/image/upload/v1550438987/Large%20Bountiful/Kiribati.jpg",
    ...
    
        {
            ...
            country: 'Madagascar',
            small_image: "https://res.cloudinary.com/divjebnjg/image/upload/v1550340096/Madagascar.jpg",
            large_image: "https://res.cloudinary.com/divjebnjg/image/upload/v1550438985/Large%20Bountiful/Madagascar.jpg",
    ...
    
        {
            title: `Ana's Story`,
            country: 'Peru',
            small_image: "https://res.cloudinary.com/divjebnjg/image/upload/v1550340095/Peru.jpg",
            large_image: "https://res.cloudinary.com/divjebnjg/image/upload/v1550438985/Large%20Bountiful/Peru.jpg",
